            ...
            <div class="col-lg-4 col-md-5">
                <div class="form-container">
                    <div class="media-container-column" data-form-type="formoid">
                        <form class="mbr-form" action="includes/check.inc.php" method="POST">
                            <div data-for="name">
                                <div class="form-group">
                                    <input type="text" class="form-control px-3" name="Aktivierungscode" data-form-field="Name" placeholder="z.B. 57777687" required="" id="name-header15-m">
                                </div>
                            </div>
